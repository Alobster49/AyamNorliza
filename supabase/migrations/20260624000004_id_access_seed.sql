...
-- Local E2E users. Supabase local auth accepts bcrypt hashes generated
-- through pgcrypto's crypt/gen_salt. These rows are deterministic so
-- `supabase db reset` restores a runnable Playwright fixture set.
with seed_users as (
  select *
  from (values
    (
