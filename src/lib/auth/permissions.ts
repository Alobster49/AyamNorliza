...
const matrix: Record<Role, ReadonlySet<Capability>> = {
  ...
  supervisor: new Set<Capability>(["audit.read", "step_up.reauth"]),
  caretaker: new Set<Capability>([]),
  veterinarian: new Set<Capability>(["step_up.reauth"]),
  biosecurity_qa: new Set<Capability>(["audit.read", "step_up.reauth"]),
