...
declare const messages: {
  ...
  "errors": {
    ...
    "drive": {
      "run": {
        ...
        "driverOnLeave": "Nobody is rostered to drive this truck today — the driver is on approved leave. Assign a cover in Driver roster first."
      },
      "stop": {
    ...
    "orders": {
      ...
      "create": {
        "invalidInput": "Invalid order input",
        "customerRequired": "customerId is required for manual orders",
        "zoneNotFound": "That delivery zone was not found.",
        "slotNotFound": "That delivery slot is no longer available.",
        "dateOutOfWindow": "Pick a delivery date within the next 14 days.",
        "weekdayMismatch": "That date does not match the slot's day of the week.",
        "dateBlocked": "Deliveries are blocked on that date. Pick another.",
        "slotFull": "That delivery slot just filled up — pick another.",
        "invalidItems": "One or more items in this order are invalid.",
        "forbidden": "You do not have permission to do that.",
        "internal": "Something went wrong. Please try again."
      },
      "confirm": {
        "invalidInput": "Invalid confirmation input",
        "invalidStatus": "This order is not in the right status for that action.",
        "forbidden": "You do not have permission to do that.",
      ...
      "close": {
        "invalidInput": "Invalid settlement input",
        "invalidStatus": "This order is not in the right status for that action.",
        "forbidden": "You do not have permission to do that.",
        "linesIncomplete": "Every line needs a final weight and price before you can close this order.",
        "invalidWeight": "Weight must be greater than zero.",
        "invalidPrice": "Price per kg cannot be negative.",
        "internal": "Something went wrong. Please try again."
      },
      "reopen": {
        "invalidStatus": "This order is not in the right status for that action.",
    ...
    "logistics": {
      "dispatch": {
        "unauthenticated": "Not authenticated",
        "orgNotFound": "Organization not found",
        "forbidden": "You do not have access to dispatch.",
        "busy": "The board is busy — try that again.",
        "runDeparted": "That run has already departed.",
  ...
  "seller": {
    ...
    "products": {
      ...
      "client": {
        ...
        "productArchivedDescription": "{name} is hidden from the shop. Past orders are untouched.",
        "productRestoredDescription": "{name} is back on sale.",
        "cannotDeleteTitle": "Cannot delete — this product has order history",
    ...
    "customers": {
      ...
      "emptyNone": "No customers yet",
      "portalBadge": "Portal",
      "editTitle": "Edit Customer",
      "nameLabel": "Name *",
      "phoneLabel": "Phone *",
      "emailLabel": "Email",
      "notesLabel": "Notes (e.g., “prefers breast cuts”)",
      "saveChanges": "Save Changes",
      "create": "Create",
  ...
  "orders": {
    ...
    "driverDeck": {
      ...
      "closeRun": {
        "button": "Close run",
        "endEarly": "End run early",
        "confirmTitle": "Close this run?",
        "confirmDone": "The run is finished. Closing it tells the office you are back.",
        "confirmRemaining": "{count, plural, one {# stop was not delivered. It goes back to the office to re-plan.} other {# stops were not delivered. They go back to the office to re-plan.}}"
      },
      ...
      "toast": {
        ...
        "finishFailedTitle": "Could not close the run",
        "finishedTitle": "Run closed",
  ...
  "logistics": {
    ...
    "dispatch": {
      ...
      "timeline": {
        "truckHeader": "Truck",
        "now": "Now",
        "atRiskBadge": "{count, plural, one {# at risk} other {# at risk}}",
        "unassignedNotice": "{count, plural, one {# unassigned (not shown — see Plan)} other {# unassigned (not shown — see Plan)}}",
        "blockTitle": "{name} · {time} · {state}",
        "agendaRow": "{truck} · {state}",
        "agendaEmpty": "Nothing scheduled for this date.",
        "state": {
          "ready": "Ready",
          "pending": "Not ready",
          "atRisk": "At risk",
      ...
      "blocked": {
        ...
        "truckDeparted": "That truck has already departed.",
        "truckAtCapacity": "That truck is at its slot capacity for this date."
      },
      "driver": {
        "label": "Driver",
        "none": "No driver",
        "noneTitle": "Nobody is rostered on this truck today — assign a cover in Driver roster before it goes out.",
        "away": "{name} is on leave"
      }
    },
    "facility": {
    ...
    "setup": {
      ...
      "readiness": {
        ...
        "issues": {
          ...
          "zoneNoPostcodes": {
            "title": "{zone} has no postcodes",
            "detail": "No customer address can be matched to this zone at checkout."
          },
          "zoneNoTruck": {
            "title": "No truck covers {zone}",
            "detail": "Orders in this zone will never be auto-assigned on the dispatch board."
          },
          "truckNoZone": {
            "title": "{truck} serves no zone",
            "detail": "Auto-plan will skip this truck, so it stays idle."
          },
          "truckNoSlots": {
            "title": "{truck} has no delivery slots",
            "detail": "Customers cannot book a delivery date on this truck."
          },
          "truckNoCapacity": {
            "title": "{truck} has no capacity set",
            "detail": "Load planning cannot warn when this truck is overbooked."
          },
          "rangeInverted": {
            "title": "Postcode range {start}–{end} is backwards",
            "detail": "The start is higher than the end, so it matches nothing."
          },
          "postcodeOverlap": {
            "title": "{zoneA} and {zoneB} claim the same postcodes",
            "detail": "{aStart}–{aEnd} overlaps {bStart}–{bEnd}. Whichever zone sorts first silently wins."
          },
          "slotOverlap": {
            "title": "{truck} has two slots at the same time",
            "detail": "{aStart}–{aEnd} overlaps {bStart}–{bEnd}. Capacity is counted twice."
          }
        }
      },
      "archived": "Archived",
      ...
      "search": {
        "postcodeMatch": "{postcode} is in {zone}",
        "slotTime": "{weekday, select, sun {Sun} mon {Mon} tue {Tue} wed {Wed} thu {Thu} fri {Fri} sat {Sat} other {}} {start}–{end}",
        "context": {
          "truck": "Truck · {code}",
          "zone": "Zone",
          "range": "Range {start}–{end}",
          "blocked": "Blocked · {truck}",
          "blockedAllTrucks": "Blocked · All trucks",
          "blockedUnknownTruck": "Blocked · Unknown truck",
          "bay": "Bay",
          "factory": "Factory · {postcode}",
          "slot": "Slot · {truck}"
        }
      }
    },
  ...
  "dataConsole": {
    ...
    "realworldCard": {
      ...
      "detail": "Driver 1-30 accounts (driver1@gmail.com …) are each truck's regular driver; driver31 and driver32 are the cover pool. The seed books leave for five drivers: two on emergency leave (one covered, one not), one on MC today (next workday on a weekend), one with a pending annual request, and one covered in yesterday's history — so the Driver roster, Leave Management and run history have something real to show.",
  ...
  "loadingBoard": {
    ...
    "capacity": {
      "onBoard": "{loaded} / {total} kg on board",
      "overCapacityBy": " · over capacity by {kg} kg",
      "freeOf": " · {free} kg free of {capacity}"
    },
    "job": {
      "undoLoadingAria": "Undo loading {name}",
      "undo": "undo",
      "markLoadedAria": "Mark {name} loaded",
      "next": "Next",
  ...
  "hr": {
    ...
    "apply": {
      ...
      "uponRequest": "Upon Request",
      "noticeHint": "Annual leave needs {days} days' notice — the earliest you can start is {date}.",
    ...
    "manage": {
      ...
      "tabs": {
        "requests": "Requests",
        "staffBalances": "Staff balances",
        "holidays": "Holidays",
        "leaveTypes": "Leave types",
        "yearClose": "Year close"
      },
      "pending": {
        "leaveSectionTitle": "Leave requests",
        "creditSectionTitle": "Credit requests",
        "emptyLeave": "No pending leave requests.",
        "emptyCredit": "No pending credit requests.",
        "dayCount": "{n} days",
        "amount": "{n} days",
        "justificationLabel": "Justification",
        "attachmentLink": "View attachment",
        "attachmentError": "Failed to open the attachment.",
        "referenceRange": "Reference {start} - {end}",
        "approve": "Approve",
        "reject": "Reject",
        "noteLabel": "Note (optional)",
        "approveTitle": "Approve this request?",
        "approveDescription": "This deducts the days from the member's balance.",
        "rejectTitle": "Reject this request?",
        "rejectDescription": "The member keeps their balance; the request is marked rejected.",
        "approveSuccess": "Request approved.",
        "rejectSuccess": "Request rejected.",
        "decisionError": "Failed to record the decision."
      },
      "staffBalances": {
        ...
        "memberColumn": "Member",
        "uponRequest": "Upon Request",
        "carryForwardRemaining": "{n} CF remaining"
      },
      "holidays": {
        ...
        "empty": "No public holidays for this year.",
        "deleteConfirmTitle": "Delete this holiday?",
        "deleteConfirmDescription": "This removes it from workday calculations for this year.",
        "deleteConfirmAction": "Delete",
        "addSuccess": "Holiday added.",
        "addError": "Failed to add the holiday.",
        "deleteSuccess": "Holiday deleted.",
        "deleteError": "Failed to delete the holiday."
      },
      "leaveTypes": {
        "title": "Leave types",
        "entitlementLabel": "Entitlement days",
        "entitlementHint": "Leave blank for Upon Request (unlimited, no balance tracked).",
        "carryForwardCapLabel": "Carry-forward cap",
        "requiresAttachmentLabel": "Requires attachment",
        "save": "Save",
        "saveSuccess": "Leave type updated.",
        "saveError": "Failed to update the leave type."
      },
      "yearClose": {
        "title": "Close leave year",
        "description": "Closing a year carries forward unused Annual Leave balance (capped per leave type) into the next year.",
        "yearLabel": "Year",
        "closeButton": "Close {year} → carry forward into {nextYear}",
        "confirmTitle": "Close {year}?",
        "confirmDescription": "This creates carry-forward ledger entries for {nextYear} and cannot be undone.",
        "confirmAction": "Close year",
        "success": "{n} carry-forward entries created.",
        "error": "Failed to close the year."
      }
    },
    "errors": {
      ...
      "insufficient_notice": "Annual leave must be applied for at least one week in advance.",
  ...
  "roster": {
    ...
    "rail": {
      "next": "Next {days} days",
      "headline": "{count, plural, =0 {every truck has a driver} one {# gap to cover} other {# gaps to cover}}",
      "gaps": "Gaps",
  ...
  "profile": {
    "edit": {
      "title": "Edit profile",
      "description": "Choose an avatar or upload your own photo.",
      "nameLabel": "Display name",
      "avatarLabel": "Avatar",
      "upload": "Upload photo",
